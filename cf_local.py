...
def temp_game():    
    # Project for AP CSP. Command Line Connect Four
    #Grid is 7 wide by 6 tall
    player1 = input("What is player one's name? ")
    player2 = input("What is player two's name? ")
    #Grid System will be using numbers and letters, ie. a1, b1, c1, ect.
    #Moves will be kept track of with dictionaries
    ...
    #This function is used to print an updated grid every time a move is made. All of the grid values are provided by the dictionaries.
    ...
    # A one or zero value will be used to determine which player's turn it is
    player_turn = 0
    #This is the updated function is the algorithm places the players markers. 
    def moves2():
